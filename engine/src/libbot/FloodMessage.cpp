...
// Konstruktor.
FloodMessage::FloodMessage( const Position& pos )
  : mPosition(pos)
{
}
...
MessageId FloodMessage::getId() const
{
    return MESSAGE_ID_FLOOD;
}

// Operiert auf einem Kontext.
bool FloodMessage::operate( IMessageOperator& oper ) const
{
